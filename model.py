...
class SpatialSelfAttention(nn.Module):
    def __init__(self, channels):
        ...
        self.quary=nn.Conv2d(channels,channels//4,kernel_size=1)
    ...
    def forward(self,x):
        ...
        Q=self.quary(x).view(batch,-1,h*w).permute(0,2,1)
...
class test_model(nn.Module):
    def __init__(self):
        ...
        self.attn = SpatialSelfAttention(channels=32)  # 注意：必须等于 conv9 的输出通道数 128
